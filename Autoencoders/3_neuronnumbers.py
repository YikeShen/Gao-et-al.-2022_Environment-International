#This is the code for different number of neurons in hidden layers.
#691-256-128-256-691, ReLu
...
for i in range(5):
    ...
    in_fea = 691
    h1 = 256 #Note: here change number of neurons in the hidden layer
    latent_size = 128
    d_output = 1
    drop_rate = 0.5
    learning_rate = [0.001]
...
OUTPUT.to_csv('691-256-128-256-691.csv',sep='\t')
