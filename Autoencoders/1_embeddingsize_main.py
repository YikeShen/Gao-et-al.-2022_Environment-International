#This is the code for different embedding size. This is the embedding size 128.
#For other embedding sizes (i.e., 2, 16, 32, 64, 128, 256) Please change the "latent_size" commented at Line xxx
#691-512-128-512-691
...
for i in range(5):
    ...
    in_fea = 691
    h1 = 512
    latent_size = 128 #Other embedding sizes (i.e., 2, 16, 32, 64, 128, 256)   
    d_output = 1
    drop_rate = 0.5
    learning_rate = [0.001]
    max_epochs = 1500
...
OUTPUT.to_csv('691-512-128-512-691_main.csv',sep='\t')
