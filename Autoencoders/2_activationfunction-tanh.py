#This is the code for different activation function-Tanh and Sigmoid. Default ReLU in 1_embeddingsize.
#For other embedding size and neuron numbers for Tanh or Sigmoid activation function, please change the "h1 &latent_size" commented at Line xxx
#691-512-128-512-691
...
#activation function change here,change to Tanh and Sigmoid accordingly
class AutoEncoder(nn.Module):
    ...
    def forward(self,x):
        x1 = self.drop(self.act1(self.l1(x)))#NOTE, this is Tanh, for Sigmoid, change to self.act2
        embedding = self.drop(self.act1(self.l2(x1)))#NOTE, this is Tanh, for Sigmoid, change to self.act2
        x2 = self.drop(self.act1(self.l3(embedding)))#NOTE, this is Tanh, for Sigmoid, change to self.act2
        x3 = self.l4(x2)
...
OUTPUT.to_csv('691-512-128-512-691_Tanh.csv',sep='\t')
